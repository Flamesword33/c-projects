 ...
 * 
 * This version uses a semaphore to ensure mutually exclusive access to the
...
int main(int argc, char *argv[])
{
    ...
    int semid;					// semaphore descriptor (ID)
	...
	if ((semid = atoi(argv[3])) == 0)
		fatal("ERROR: Semaphore ID not converted to int.");
